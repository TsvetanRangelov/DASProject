...
public class SWRRServer extends java.rmi.server.UnicastRemoteObject 
implements ISWRRServer,Runnable {

	
	private static final long serialVersionUID = 1L;
	private final static Logger LOGGER = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME);

	private ISWRRBalancer balancer;
	...
	//default constructor
	protected SWRRServer() throws RemoteException {
		super();
		
	}
	
	public SWRRServer(String balancerip, int _registryport,String _serverName, int capacity)  throws RemoteException, MalformedURLException, NotBoundException{
	...
	@Override
	public  String addPatient(ClientRequest client) throws RemoteException {
	...
	public  void run() {
		try {
			...
			this.balancer = (ISWRRBalancer) Naming.lookup("rmi://" + this.BalancerIP + ":" + this.registryport + "/WRRBalancer");
